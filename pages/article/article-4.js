...
export default function Article() {
  ...
  const title =
    'What are other forms of local government in Nepal? Specifically, what is the purpose of the Pradesh Sabhas? What were the conversations that led to Nepal adopting these systems?'
