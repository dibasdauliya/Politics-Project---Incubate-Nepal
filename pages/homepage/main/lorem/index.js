...
import { Line, MainLayout, SectionHeader } from '@/components/layout'
import Head from 'next/head'
import { Heading3, Title } from '@/components/typography'
      ...
      <Box>
        <Box>
          <Text mb='1.5em'>
            ...
            collaborate on open ended projects. Mentored by our very own Bhushan
            Suwal dai and Co-mentored by Aayushka Budhathoki, the project
            focuses on the Representation in the Legislative Parliament of
            Nepal. What started with countless of layman opinions about politics
            gradually consolidated into factual information and rational
            analysis. The group name "Team Samsad" which was initially titled
            for fun proved to be a thread which connected the group into a close
            knitted circle.
          </Text>
          ...
          <TeamCard
            ...
            // youtube={undefined}
          >
            Politics and social affairs were never something I preferred reading
            or discussing before. But, unexpectedly, this experience pushed me
            to dig into a wide range of the country's political situation that
            changed my overall perspective in this area. Also, getting to work
            with highly motivating and supportive teammates was one of the best
            parts of this program. VERY GRATEFUL!
          </TeamCard>
          ...
          >
            ...
            working mechanism. This journey became pleasant due to the presence
            of my lovely fellow travelers. I learnt a lot about working
            together.
          </TeamCard>
          ...
          >
            ...
            problem-solving skills and learned more about researching the facts
            and dealing with the different perspectives of many articles by
            discussing them with energetic teammates. I am thankful to all the
            members for their inspiration and motivation.
          </TeamCard>
          ...
          <TeamCard
            ...
            fd='row-reverse'
          >
            This project made me realize how we have a general tendency to make
            opinions without things, without evidence. In addition to looking at
            my opinions, I now look at why I hold them.
          </TeamCard>
          ...
          <TeamCard
            ...
            // youtube={undefined}
          >
            Incubate Nepal was an exhilarating process for me. What I thought to
            be a rigorous project was all about fun discussions, common
            conclusions and gaining an insight of the political system of Nepal.
            Apart from the main project itself, grateful to have formed amazing
            connections with such talented teammates.
          </TeamCard>
